...
#1)All raised exception should have been managed, i.e no exception caught in tester.
...
PROJECT_DIR = "~/home/coding/42/python-for-data-science"
ARRAY_DIR = os.path.dirname(os.path.abspath(__file__))
...
def test_sain_args(data: json, output_file:TextIO):
    ...
    for arg, exp in zip(cases, expected):
        ...
        with ctxlib.redirect_stdout(captured_output):
            try:
                res_apply_limit = give_bmi(arg[0], arg[1])
